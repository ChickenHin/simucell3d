...
> **Note:** This is a historical archive of the original v1.0 README. Clone URLs below reference the original ETH Zurich repository. The current repo is at `https://github.com/nilesh-patil/simucell3d`.
...
<p align="center">
    <img src="./img/simucell_topolgy_example.png">
</p>
...
<br>
More information on the structure of these files can be found at [here](./parameter_file_doc.md) and [here](./input_mesh_format.md)
...
The `simulation _statistics.csv` file contains simulation statistics such as the cell areas and volumes over time. More information on this file can be found [here](./output_statistics.md). 
...
- [How to configure the parameters of a simulation?](./parameter_file_doc.md)
- [How are input meshes formatted?](./input_mesh_format.md)
- [How to generate initial geometries?](./mesh_generation.md)
- [What are the files saved by SimuCell3D?](./output_statistics.md)  
- [How to run a parameter screen on a cluster?](./parameter_screen.md)
- [How to run SimuCell3D from python?](./python_support.md)
