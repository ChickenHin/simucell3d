...
The path to the input mesh file is given in the XML tag <input_mesh_file_path>. This input mesh file has to follow a specific format which is explained in more detail [here](./input-mesh-format.md). 
